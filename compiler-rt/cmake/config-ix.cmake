...
if(APPLE)
  ...
  list_intersect(SHADOWCALLSTACK_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(FLEXFAT_SUPPORTED_ARCH
    ALL_FLEXFAT_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(SHADOWCALLSTACK_SUPPORTED_ARCH
    ${ALL_SHADOWCALLSTACK_SUPPORTED_ARCH})
  filter_available_targets(FLEXFAT_SUPPORTED_ARCH ${ALL_FLEXFAT_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;rtsan;dfsan;msan;hwasan;tsan;tysan;safestack;cfi;scudo_standalone;ubsan_minimal;gwp_asan;nsan;asan_abi;flexfat)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND FLEXFAT_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Darwin|Linux")
  set(COMPILER_RT_HAS_FLEXFAT TRUE)
else()
  set(COMPILER_RT_HAS_FLEXFAT FALSE)
endif()

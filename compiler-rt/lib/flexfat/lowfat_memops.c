 ...
 *
 * FlexFat: bounds-checked memset/memmove/memcpy, a verbatim port of the
 * reference LowFat lowfat_memops.c. #included into lowfat.c. Each validates
 * lowfat_buffer_size(dst/src) >= n (reporting via lowfat_oob_error on overflow)
 * then delegates to libc; memcpy is memmove.
 */

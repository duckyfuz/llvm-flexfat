//===-- flexfat_stack.cpp - FlexFat stack trace implementation ------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Provides BufferedStackTrace::UnwindImpl for the FlexFat runtime.
//
// FlexFat does not maintain a thread registry, so we obtain the stack bounds
